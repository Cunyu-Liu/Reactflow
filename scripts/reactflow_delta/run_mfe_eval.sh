#!/usr/bin/env bash
# run_mfe_eval.sh - screen the ViennaRNA MFE thermodynamic feature modality
set -euo pipefail
...
OUT=/mnt/cunyuliu/m2r_mfe_eval_20260818
cd /home/cunyuliu/reactflow_delta_worktrees/benchmark_v3_20260809/scripts/reactflow_delta
/home/cunyuliu/miniconda3/envs/editflow/bin/python m2r_mfe_eval_v1.py \
