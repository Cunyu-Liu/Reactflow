#!/usr/bin/env bash
# run_multiseed.sh - multi-seed averaging lever for M2R
set -euo pipefail
...
/home/cunyuliu/miniconda3/envs/editflow/bin/python m2r_multiseed_v1.py \
  --m2r-csv "$M2R" --m2-csv "$M2" --m2-pred "$M2PRED" --out "$OUT" --k-seeds 5
echo "EXIT=$?"
