...
CKPT_PATH = Path("/mnt/cunyuliu/reactflow_delta_artifacts_20260729/m0r2/pilot_v1/best_checkpoint.pt")
TRAIN_LOG_PATH = Path("/mnt/cunyuliu/reactflow_delta_artifacts_20260729/m0r2/pilot_v1/train_log.json")
