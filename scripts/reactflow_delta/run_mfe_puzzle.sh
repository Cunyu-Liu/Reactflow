#!/usr/bin/env bash
# run_mfe_puzzle.sh - puzzle-level leak-free multi-seed 3-way + MFE features
set -euo pipefail
...
BASE=/mnt/cunyuliu/m2r_multiseed_puzzle_20260817/m2r_multiseed_puzzle_oof.npz
OUT=/mnt/cunyuliu/m2r_mfe_puzzle_20260818
cd /home/cunyuliu/reactflow_delta_worktrees/benchmark_v3_20260809/scripts/reactflow_delta
/home/cunyuliu/miniconda3/envs/editflow/bin/python m2r_mfe_puzzle_v1.py \
