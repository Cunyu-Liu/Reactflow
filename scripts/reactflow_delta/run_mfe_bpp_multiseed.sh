#!/usr/bin/env bash
# run_mfe_bpp_multiseed.sh - full multi-seed audit of MFE+BPP features
set -euo pipefail
...
BASE_NPZ=/mnt/cunyuliu/m2r_mfe_multiseed_20260818/m2r_mfe_multiseed_oof.npz
OUT=/mnt/cunyuliu/m2r_mfe_bpp_multiseed_20260818
cd /home/cunyuliu/reactflow_delta_worktrees/benchmark_v3_20260809/scripts/reactflow_delta
/home/cunyuliu/miniconda3/envs/editflow/bin/python m2r_mfe_bpp_multiseed_v1.py \
  --m2r-csv "$M2R" --m2-csv "$M2" --m2-pred "$M2PRED" --base-npz "$BASE_NPZ" --out "$OUT"
echo "EXIT=$?"
