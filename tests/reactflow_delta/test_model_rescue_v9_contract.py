...
def test_v9m0_is_implementation_only_and_preserves_v8_terminal() -> None:
    ...
    assert active["runnable_phases"] == ["V9M0"]
    ...
    assert contract["contract_status"] == "V9M0_IMPLEMENTATION_AUTHORIZED"
